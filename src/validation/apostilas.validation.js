...
export const validateApostilaData = (data) => {
    return ApostilaSchema.safeParse(data);
};
export const validateApostilaUpdateData = (data) => {
    return UpdateApostilaSchema.safeParse(data);
};
export const validateApostilaFiltersData = (data) => {
...
//# sourceMappingURL=apostilas.validation.js.map
...
export const validateFlashcardUpdateData = (data) => {
    return UpdateFlashcardSchema.safeParse(data);
};
export const validateFlashcardFiltersData = (data) => {
    return FlashcardFiltersSchema.safeParse(data);
};
export const validateUserFlashcardProgressData = (data) => {
    return UserFlashcardProgressSchema.safeParse(data);
};
export const validateUserFlashcardProgressUpdateData = (data) => {
...
//# sourceMappingURL=flashcards.validation.js.map